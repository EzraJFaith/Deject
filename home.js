...
const U_cards = [
  ...
  {id: 30, deck: "uncommon", name: "Mermunch", damage: 5, health: 3, speed: 2, type: "natural", nature: "basic", ability: "x", abilityText: "Teammates heal +1HP every turn", description: "x", version: "1/3", image: "Pictures/Fairy.JPG"},
...
const R_cards = [
  {id: 0, deck: "rare", name: "Giabog", damage: 4, health: 13, speed: 3, type: "natural", nature: "basic", ability: "x", abilityText: "Giabog can deal +4 damage to any oppoenet after death", description: "x", version: "1/3", image: "Pictures/Giabog1.JPG"},
  ...
  {id: 3, deck: "rare", name: "Tiki", damage: 3, health: 12, speed: 3, type: "natural", nature: "basic", ability: "x", abilityText: "Tiki gains +2 Attack every turn ", description: "x", version: "1/2", image: "Pictures/Tiki1.JPG"},
  {id: 4, deck: "rare", name: "Mooses", damage: 4, health: 15, speed: 0, type: "natural", nature: "basic", ability: "x", abilityText: "If Mooses dies during battle, fully heal one teammember", description: "x", version: "1/2", image: "Pictures/Mooses1.JPG"},
  ...
  {id: 6, deck: "rare", name: "Motivox", damage: 1, health: 14, speed: 8, type: "natural", nature: "basic", ability: "x", abilityText: "Raise teammates speed by +3", description: "x", version: "1/2", image: "Pictures/Motivox1.JPG"},
  ...
  {id: 10, deck: "rare", name: "Messaver", damage: 3, health: 4, speed: 8, type: "natural", nature: "basic", ability: "x", abilityText: "Allow access to battle station from anywhere once", description: "x", version: "1/2", image: "Pictures/Messaver1.JPG"},
  {id: 11, deck: "rare", name: "Guardinal", damage: 3, health: 15, speed: 1, type: "natural", nature: "basic", ability: "x", abilityText: "Prevent enemy abilities until Guardinal dies", description: "x", version: "1/2", image: "Pictures/CatStupid.webp"},
  ...
  {id: 13, deck: "rare", name: "Spiritrap", damage: 4, health: 9, speed: 3, type: "natural", nature: "basic", ability: "x", abilityText: "Gain double P from Yellow space", description: "x", version: "1/3", image: "Pictures/Spiritrap1.JPG"},
  ...
  {id: 15, deck: "rare", name: "Flups", damage: 4, health: 10, speed: 5, type: "natural", nature: "basic", ability: "x", abilityText: "Heal a teammate for 7 health once", description: "x", version: "1/3", image: "Pictures/Flups1.JPG"},
  {id: 16, deck: "rare", name: "Whizz", damage: 2, health: 7, speed: 2, type: "natural", nature: "basic", ability: "x", abilityText: "Gain +2 Attack against opponenets with speed under 4", description: "x", version: "1/3", image: "Pictures/Whizz1.JPG"},
...
const UTwo_cards = [
  ...
  {id: 30, deck: "uncommonTwo", name: "Mermunch", damage: 8, health: 5, speed: 3, type: "natural", nature: "basic", ability: "x", abilityText: "Teammates heal +2HP every turn", description: "x", version: "2/3", image: "Pictures/Fairy.JPG"},
